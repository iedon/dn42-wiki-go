...
- `git.pushIntervalSec` *(int, default `0`)*: Seconds between background `git push` attempts. Use `0` to disable scheduling. Automatically ignored when `git.remote` is empty.
